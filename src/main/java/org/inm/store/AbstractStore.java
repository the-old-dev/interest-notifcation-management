...
public abstract class AbstractStore<T extends Serializable> extends AbstractStoreBase<T> {
	...
	public T insert(T entity) {
		...
		if (getSearch(entity).exists(entity)) {
			throw new IllegalArgumentException(
					"This entity exists allready in the Store, entity:=" + entity.toString());
		}
	...
	public void update(T entity) {
		...
		if (!getSearch(entity).exists(entity)) {
			throw new IllegalArgumentException(
					"Update not possible, this entity does not exist in the Store" + entity.toString());
		}
	...
	public void delete(T entity) {
		...
		if (!getSearch(entity).exists(entity)) {
			throw new IllegalArgumentException(
					"Delete not possible, this entity does not exist in the Store" + entity.toString());
		}
