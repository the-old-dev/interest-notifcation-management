= Experimental Project based on an OpenShift Template (REST API Level 0 - Spring Boot Booster)
...
----
$ git clone git@github.com:the-old-dev/interest-notifcation-management

$ cd interest-notifcation-management
...
To interact with your Project while it's running locally, use the form at `http://localhost:8080` or the `curl` command:
